...
TEMPLATES = [
    {
        ...
        'DIRS': ['templates',OSCAR_MAIN_TEMPLATE_DIR,ACCOUNTS_TEMPLATE_DIR],
        'APP_DIRS': False,
        'OPTIONS': {
            'loaders': [
...
STATIC_URL = 'http://bowanddrape.3dact.com/static/'
...
FANDJANGO_SITE_URL = 'http://bowanddrape.3dact.com'
...
BOWER_COMPONENTS_ROOT = '/var/www/vhosts/bowanddrape.3dact.com/commerce/'
