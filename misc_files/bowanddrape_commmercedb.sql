...
1	Mr	Dmitry	Roitman	150 West End Avenue	Apt. 6D	Brooklyn	New York	New York	11235	Dmitry Roitman 150 West End Avenue Apt. 6D Brooklyn New York New York 11235 United States of America	+17184046471		f	f	2	-628364552	2016-08-09 23:47:04.34496-04	US	1
\.
...
SELECT pg_catalog.setval('analytics_userproductview_id_seq', 3, true);
...
1	3	7	2	2	4	79.80	2016-08-10 00:06:42.578886-04	1
\.
...
1	pbkdf2_sha256$24000$nwe5ecicQBxC$2Tfub7KRilH6QqPSf3RmytKVV30IVK1C0zyOwO7Ax/g=	2016-08-10 11:45:43-04	t	root	Bow &	Drape	dmitry@bowanddrape.com	t	t	2016-08-09 06:34:02-04
\.
...
8	Open	2016-08-10 00:06:56.739938-04	\N	\N	1
...
SELECT pg_catalog.setval('basket_basket_id_seq', 9, true);
...
SELECT pg_catalog.setval('basket_line_id_seq', 8, true);
...
1	0001	1	0	sweatshirts	<p>Sweatshirts Category</p>	categories/image_shirt.jpg	sweathirts
\.
...
3	standalone	10012	Cool Sweatshirt	cool-sweatshirt	<p>Cool Sweatshirt</p>	5	2016-08-09 11:51:50.661853-04	2016-08-09 11:52:39.13222-04	t	\N	1
\.
...
SELECT pg_catalog.setval('catalogue_productattribute_id_seq', 1, false);
...
1	images/products/2016/08/image_shirt.jpg		0	2016-08-09 11:51:50.83175-04	3
\.
...
SELECT pg_catalog.setval('catalogue_productimage_id_seq', 1, true);
...
SELECT pg_catalog.setval('customer_email_id_seq', 2, true);
...
SELECT pg_catalog.setval('offer_benefit_id_seq', 1, true);
...
SELECT pg_catalog.setval('offer_condition_id_seq', 1, true);
...
1	sample offer	sample-offer	<p>sample offer</p>	Site	Open	0	2016-08-10 00:00:00-04	2016-10-07 05:00:30-04	20	20	1	10.00	0.20	1	1		2016-08-10 00:05:40.138423-04	1	1
\.
...
SELECT pg_catalog.setval('offer_conditionaloffer_id_seq', 1, true);
...
SELECT pg_catalog.setval('order_line_id_seq', 3, true);
...
SELECT pg_catalog.setval('order_lineprice_id_seq', 3, true);
...
SELECT pg_catalog.setval('order_orderdiscount_id_seq', 1, true);
...
SELECT pg_catalog.setval('order_shippingaddress_id_seq', 3, true);
...
SELECT pg_catalog.setval('oscar_accounts_accounttype_id_seq', 1, false);
...
1	10211	USD	20.00	20.00	20.00	20	7	10	2016-08-09 11:51:50.864439-04	2016-08-10 00:06:42.645221-04	1	3
\.
...
sorl-thumbnail||image||e6f4223b5ee8df6d2ecbfd1762ef4453	{"storage": "django.core.files.storage.FileSystemStorage", "name": "images/products/2016/08/image_shirt.jpg", "size": [286, 430]}
sorl-thumbnail||image||30c9fed2afe7eed602bbe93702cc6d36	{"storage": "django.core.files.storage.FileSystemStorage", "name": "cache/f4/44/f4446a78a56c897db777a052c12402dd.jpg", "size": [47, 70]}
sorl-thumbnail||thumbnails||e6f4223b5ee8df6d2ecbfd1762ef4453	["30c9fed2afe7eed602bbe93702cc6d36"]
